...
module.exports = {
    ...
    async execute(msg, args) {
        ...
        await axios.get(`http://swquotesapi.digitaljedi.dk/api/SWQuote/RandomStarWarsQuoteFromFaction/${faction}`)
        .then(async response => {
            await axios.get('https://translate.yandex.net/api/v1.5/tr.json/translate', {
                params: {
